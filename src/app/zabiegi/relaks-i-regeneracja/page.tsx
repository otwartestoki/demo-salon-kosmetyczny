    ...
    <main className="min-h-screen bg-[#070806] px-5 py-12 text-[#f5efe3] md:px-10">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[.9fr_1.1fr]">
        <div>
          ...
          <h1 className="serif mt-12 text-5xl uppercase leading-none tracking-[.08em] text-white md:text-7xl">Relaks i regeneracja</h1>
          <p className="mt-6 text-lg leading-9 text-[#c7bba7]">Spokojne zabiegi regeneracyjne na twarz i ciało w eleganckim, kameralnym miejscu.</p>
        ...
        <img src="/pani/salon-interior-hd.jpg" alt="Relaks i regeneracja" className="mt-16 h-[520px] w-full rounded-xl border border-[#b8893e]/30 object-cover shadow-2xl shadow-black/40" />
      </div>
    </main>
  );
}
